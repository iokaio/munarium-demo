...
public final class FilesUtil {
    private FilesUtil() {}
    public static String json(Object value) throws Exception { return Json.MAPPER.writer().with(com.fasterxml.jackson.databind.SerializationFeature.ORDER_MAP_ENTRIES_BY_KEYS).writeValueAsString(value); }
    ...
    public static void write(Path path, String text) throws Exception {
        ...
        Path temporary = Files.createTempFile(path.toAbsolutePath().getParent(), ".reconcile-", ".tmp");
        try {
