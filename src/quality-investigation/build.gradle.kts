...
application { mainClass = "io.ioka.demo.quality.Main" }
...
tasks.test {
    ...
    useJUnitPlatform { includeTags(System.getenv("QUALITY_TEST_KIND") ?: "unit") }
    outputs.upToDateWhen { false }
    testLogging { events("passed", "failed", "skipped") }
    reports.junitXml.outputLocation = file((System.getenv("QUALITY_REPORT_DIR") ?: "build/reports/run") + "/junit")
}
